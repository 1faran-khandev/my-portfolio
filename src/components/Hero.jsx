    ...
    >
      ...
      >
        ...
        <div className="inline-flex items-center gap-2 px-4 py-1 rounded-full border border-gray-700 text-gray-400 text-sm mb-6">
          ...
          Open to Frontend & Software Engineering Opportunities
        </div>
        ...
        <p className="mt-3 text-sm text-gray-500">
          React • Next.js • TypeScript • JavaScript • Tailwind CSS • Python • REST APIs
        </p>
        ...
        <p className="mt-6 text-sm text-gray-500 max-w-xl mx-auto">
          I build responsive web applications, integrate APIs, and create
          modern user interfaces with a focus on performance, usability, and
          clean code.
        </p>
      </motion.div>
