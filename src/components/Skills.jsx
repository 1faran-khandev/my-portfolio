...
const skills = [
  ...
  { icon: <FaPython />, name: "Python (Basic)", color: "text-yellow-200" },
];
      ...
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        >
          ...
          <p className="text-gray-400 mt-4 max-w-2xl mx-auto text-sm md:text-base">
            Technologies I use to build modern, fast, and scalable web applications.
          </p>
        </motion.div>
          ...
          {skills.map((skill, index) => (
            <motion.div key={index} variants={item}>
              <div className="group rounded-xl border border-gray-800 bg-white/5 p-6 hover:bg-white/10 transition">
                ...
                <div className={`text-4xl mb-3 flex justify-center ${skill.color}`}>
                  {skill.icon}
                </div>
